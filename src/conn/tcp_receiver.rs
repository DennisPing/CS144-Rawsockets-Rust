...
use crate::conn::stream_reassembler::StreamReassembler;
...
pub struct TCPReceiver {
    ...
    reassembler: StreamReassembler, // Handles TCP segments
...
impl TCPReceiver {
    pub fn new(capacity: usize) -> Self {
        TCPReceiver {
            ...
            reassembler: StreamReassembler::new(ByteStream::new(capacity)),
            isn: None,
        }
    }
